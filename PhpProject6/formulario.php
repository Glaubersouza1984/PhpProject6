...
if ($acao == "") {
    $resgatarProduto = array("produto" => "", "descricao" => "",
        "quantidade" => "", "valor" => "");
}
?>
        ...
        <div class="col col-lg-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="produto" 
                       name="produto" value="<?= $resgatarProduto["produto"]; ?>">
            </div>
            <div class="form-group">
                <label for="descricao">Descrição:</label>
                <input type="text" class="form-control" id="descricao" 
                       name="descricao" value="<?= $resgatarProduto["descricao"]; ?>">
            </div>
        </div>
    </div> 
    <div class="row">
        <div class="col col-lg-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="quantidade" 
                       name="quantidade" value="<?= $resgatarProduto["quantidade"]; ?>">
            </div>
        </div>
        <div class="col col-lg-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" 
                       id="valor" name="valor" value="<?= $resgatarProduto["valor"]; ?>">
            </div> 
        </div>
    </div>
    <div class="row">
